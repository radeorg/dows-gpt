...
import org.dows.gpt.deepseek.constant.DeepSeekConst;
import org.dows.gpt.deepseek.sse.DefaultPluginListener;
import org.dows.gpt.deepseek.sse.PluginListener;
import org.dows.gpt.llm.openai.OpenAiApi;
import org.dows.gpt.llm.openai.constant.OpenAIConst;
import org.dows.gpt.llm.openai.entity.Tts.TextToSpeech;
import org.dows.gpt.llm.openai.entity.assistant.*;
import org.dows.gpt.llm.openai.entity.assistant.message.MessageFileResponse;
import org.dows.gpt.llm.openai.entity.assistant.message.MessageResponse;
import org.dows.gpt.llm.openai.entity.assistant.message.ModifyMessage;
import org.dows.gpt.llm.openai.entity.assistant.run.*;
import org.dows.gpt.llm.openai.entity.assistant.thread.ModifyThread;
import org.dows.gpt.llm.openai.entity.assistant.thread.Thread;
import org.dows.gpt.llm.openai.entity.assistant.thread.ThreadMessage;
import org.dows.gpt.llm.openai.entity.assistant.thread.ThreadResponse;
import org.dows.gpt.llm.openai.entity.billing.BillingUsage;
import org.dows.gpt.llm.openai.entity.billing.CreditGrantsResponse;
import org.dows.gpt.llm.openai.entity.billing.Subscription;
import org.dows.gpt.llm.openai.entity.chat.*;
import org.dows.gpt.llm.openai.entity.common.DeleteResponse;
import org.dows.gpt.llm.openai.entity.common.OpenAiResponse;
import org.dows.gpt.llm.openai.entity.common.PageRequest;
import org.dows.gpt.llm.openai.entity.completions.Completion;
import org.dows.gpt.llm.openai.entity.completions.CompletionResponse;
import org.dows.gpt.llm.openai.entity.edits.Edit;
import org.dows.gpt.llm.openai.entity.edits.EditResponse;
import org.dows.gpt.llm.openai.entity.embeddings.Embedding;
import org.dows.gpt.llm.openai.entity.embeddings.EmbeddingResponse;
import org.dows.gpt.llm.openai.entity.engines.Engine;
import org.dows.gpt.llm.openai.entity.files.File;
import org.dows.gpt.llm.openai.entity.files.UploadFileResponse;
import org.dows.gpt.llm.openai.entity.fineTune.Event;
import org.dows.gpt.llm.openai.entity.fineTune.FineTune;
import org.dows.gpt.llm.openai.entity.fineTune.FineTuneDeleteResponse;
import org.dows.gpt.llm.openai.entity.fineTune.FineTuneResponse;
import org.dows.gpt.llm.openai.entity.fineTune.job.FineTuneJob;
import org.dows.gpt.llm.openai.entity.fineTune.job.FineTuneJobEvent;
import org.dows.gpt.llm.openai.entity.fineTune.job.FineTuneJobListResponse;
import org.dows.gpt.llm.openai.entity.fineTune.job.FineTuneJobResponse;
import org.dows.gpt.llm.openai.entity.images.Image;
import org.dows.gpt.llm.openai.entity.images.ImageEdit;
import org.dows.gpt.llm.openai.entity.images.ImageResponse;
import org.dows.gpt.llm.openai.entity.images.Item;
import org.dows.gpt.llm.openai.entity.models.Model;
import org.dows.gpt.llm.openai.entity.models.ModelResponse;
import org.dows.gpt.llm.openai.entity.images.ImageVariations;
import org.dows.gpt.llm.openai.entity.moderations.Moderation;
import org.dows.gpt.llm.openai.entity.moderations.ModerationResponse;
import org.dows.gpt.llm.openai.entity.whisper.Transcriptions;
import org.dows.gpt.llm.openai.entity.whisper.Translations;
import org.dows.gpt.llm.openai.entity.whisper.WhisperResponse;
import org.dows.gpt.llm.openai.exception.BaseException;
import org.dows.gpt.llm.openai.exception.CommonError;
import org.dows.gpt.llm.openai.function.KeyRandomStrategy;
import org.dows.gpt.llm.openai.function.KeyStrategyFunction;
import org.dows.gpt.llm.openai.interceptor.DefaultOpenAiAuthInterceptor;
import org.dows.gpt.llm.openai.interceptor.DynamicKeyOpenAiAuthInterceptor;
import org.dows.gpt.llm.openai.interceptor.OpenAILogger;
import org.dows.gpt.llm.openai.interceptor.OpenAiAuthInterceptor;
import org.dows.gpt.llm.openai.plugin.PluginAbstract;
import org.dows.gpt.llm.openai.plugin.PluginParam;
import org.dows.gpt.llm.openai.utils.SSEUtil;
...
//    }
    ...
    public void streamCompletions(Completion completion, EventSourceListener eventSourceListener) {
        if (Objects.isNull(eventSourceListener)) {
            log.error("参数异常：EventSourceListener不能为空，可以参考：org.dows.gpt.llm.openai.sse.ConsoleEventSourceListener");
            throw new BaseException(CommonError.PARAM_ERROR);
        }
